  ...
  const BLOCKSCOUT_LINKS = [
    {
      ...
      url: "info@afgcoin.net",
    },
    {
      icon: "contact" as const,
      iconSize: "18px",
      text: "X (ex-Twitter)",
      url: "https://x.com/AfgCoinOfficial",
    },
    {
      icon: "youtube" as const,
      iconSize: "24px",
      text: "YouTube",
      url: "https://www.youtube.com/@AfgCoinOfficial",
    },
    {
      icon: "Telegram" as const,
      iconSize: "18px",
      text: "Telegram",
      url: "https://www.youtube.com/redirect?event=channel_description&redir_token=QUFFLUhqbnctY0hJczBtTnhneXJCejBxOURGNTFwVHg5Z3xBQ3Jtc0tsSUVCT1RLcHRhSTlBb3NsTGRNbGpIOElpSjVZTFFPWjU4ZDlXNm9lV0Z0MDk3Q3NiRzB6VjNCZlJjaHNibmZzUXZibDR0RUdiY3BPVmEzY01YTzZXVnplRldTNkFBY1RwNWJkZGxfazFMVGJPMlR5WQ&q=https%3A%2F%2Ft.me%2FAfgCoinOfficial",
    },
  ];
        ...
        <Box gridArea={gridArea}>
          ...
          <Box mt={6} alignItems="start" textStyle="xs">
            {/* {apiVersionUrl && (
              <Text>
                Backend:{" "}
                <Link href={apiVersionUrl} external noIcon>
            ...
            <Text>
              Copyright {copy} AFGCoin {new Date().getFullYear()}
            </Text>
          </Box>
        </Box>
      );
